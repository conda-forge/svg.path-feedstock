...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/svg.path-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11905&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/svg.path-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `svg.path` can be installed with:

```
conda install svg.path
```

It is possible to list all of the versions of `svg.path` available on your platform with:
